      ...
      final unitId = await insertUnit(
        ...
        description: chunkIndex == 1
            ? 'Кандзи не учат по одному — каждый иероглиф сразу привязан к '
                ...
                '\n\nУ каждого кандзи на карточке — два вида чтений:\n'
                '• он (онъёми) — чтение, пришедшее из китайского, обычно '
                'используется, когда кандзи стоит в сочетании с другими '
                '(語 в составе 日本語 читается как ゴ);\n'
                '• кун (кунъёми) — исконно японское чтение, обычно используется, '
                'когда кандзи стоит один, часто с окончанием хираганой (語 само '
                'по себе как глагол 語る читается как かた.る).\n'
                'У одного кандзи бывает несколько чтений каждого вида — со временем '
                'ухо и глаз начинают подсказывать, какое где уместно.'
